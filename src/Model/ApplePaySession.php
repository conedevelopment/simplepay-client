...
class ApplePaySession implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ApplePaySession';
    ...
    public function setDiscount(?float $discount): static
    {
        ...
        if (($discount < 0)) {
            throw new InvalidArgumentException('invalid value for $discount when calling ApplePaySession., must be bigger than or equal to 0.');
        }
    ...
    public function setShippingCost(?float $shippingCost): static
    {
        ...
        if (($shippingCost < 0)) {
            throw new InvalidArgumentException('invalid value for $shippingCost when calling ApplePaySession., must be bigger than or equal to 0.');
        }
    ...
    public function setTotal(?float $total): static
    {
        ...
        if (($total <= 0)) {
            throw new InvalidArgumentException('invalid value for $total when calling ApplePaySession., must be bigger than 0.');
        }
     ...
     * Sets domain
     *
     * @param string $domain The FQDN registered for ApplePay.
     *
     * @return $this
     */
