...
class EamTransaciton implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    public const EAM_TYPE_NUMBER_1 = 1;
    public const EAM_TYPE_NUMBER_2 = 2;
    public const EAM_TYPE_NUMBER_3 = 3;
    public const EAM_TYPE_NUMBER_4 = 4;
    public const EAM_TYPE_NUMBER_5 = 5;
    public const EAM_TYPE_NUMBER_6 = 6;
    public const EAM_TYPE_NUMBER_7 = 7;
     ...
     * @return string[]
     */
    public static function getEamTypeAllowableValues()
    {
        return [
            self::EAM_TYPE_NUMBER_1,
            self::EAM_TYPE_NUMBER_2,
            self::EAM_TYPE_NUMBER_3,
            self::EAM_TYPE_NUMBER_4,
            self::EAM_TYPE_NUMBER_5,
            self::EAM_TYPE_NUMBER_6,
            self::EAM_TYPE_NUMBER_7,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('eamType', $data ?? [], null);
    }
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['eamType'] === null) {
            $invalidProperties[] = "'eamType' can't be null";
        }
        $allowedValues = self::getEamTypeAllowableValues();
        if (!is_null($this->container['eamType']) && !in_array($this->container['eamType'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'eamType', must be one of '%s'",
                $this->container['eamType'],
     ...
     * Gets language
     *
     * @return \Cone\SimplePay\Model\Language
     */
     ...
     * Sets language
     *
     * @param \Cone\SimplePay\Model\Language $language language
     *
     * @return $this
     */
     ...
     * Gets methods
     *
     * @return \Cone\SimplePay\Model\Method[]
     */
     ...
     * Sets methods
     *
     * @param \Cone\SimplePay\Model\Method[] $methods Possible values: CARD, WIRE or EAM.
     *
     * @return $this
     */
     ...
     * Sets timeout
     *
     * @param string $timeout The ISO 8601 format of the timeout date.
     *
     * @return $this
     */
     ...
     * @return int
     */
    public function getEamType(): int
    {
        return $this->container['eamType'];
    }

    /**
     * Sets eamType
     *
     * @param int $eamType 1: QR, 2: Deeplink, 3: NFC, 4: QR+ Deeplink, 5: QR+NFC, 6: Deeplink +NFC, 7: QR+DL+NFC
     *
     * @return $this
     */
    public function setEamType(int $eamType): static
    {
        if (is_null($eamType)) {
            throw new InvalidArgumentException('non-nullable eamType cannot be null');
        }
        $allowedValues = self::getEamTypeAllowableValues();
        if (!in_array($eamType, $allowedValues, true)) {
        ...
        $this->container['eamType'] = $eamType;
