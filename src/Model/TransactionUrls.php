...
/**
 * TransactionUrls Class Doc Comment
 *
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements ArrayAccess<string, mixed>
 */
class TransactionUrls implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'Transaction_urls';
     ...
     * Sets fail
     *
     * @param string|null $fail fail
     *
     * @return $this
     */
    public function setFail(?string $fail): static
    {
        if (is_null($fail)) {
